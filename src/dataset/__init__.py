...
from .lsun_horses import LsunHorsesDataset
from .folder import AbstractFolderDataset
from .inat_mammalnet import INatMammalNetlDataset
...
def get_dataset(dataset_name):
    datasets = {
        ...
        'lsun_horses': LsunHorsesDataset,
        'inat_mammalnet': INatMammalNetlDataset,
    }
